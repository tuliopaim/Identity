...
namespace Identity.API.Migrations
{
    ...
    [Migration("20210904135742_AlteraNomeDasTabelasDoIdentity")]
    partial class AlteraNomeDasTabelasDoIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.API.Business.Entities.UsuarioPerfil", b =>
                {
            ...
            modelBuilder.Entity("Identity.API.Business.Entities.UsuarioPermissao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Identity.API.Business.Entities.UsuarioPerfil", b =>
                {
                    ...
                    b.HasOne("Identity.API.Business.Entities.Usuario", "Usuario")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserLogin<System.Guid>", b =>
                {
                    b.HasOne("Identity.API.Business.Entities.Usuario", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
